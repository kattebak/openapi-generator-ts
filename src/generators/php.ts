 ...
 */
export function getPhpAdditionalProperties(config: CodegenConfig): Record<string, unknown> {
  ...
  return {
    ...
    artifactUrl: config.additionalProperties?.artifactUrl ?? 'https://openapi-generator.tech',
    ...
    developerOrganizationUrl:
      config.additionalProperties?.developerOrganizationUrl ?? 'https://openapi-generator.tech',
